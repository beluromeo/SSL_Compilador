...
echo "5 3" | (./micro ejemplo.micro > /dev/null 2>&1 && gcc -o programa output.c 2>&1 > /dev/null && ./programa 2>/dev/null)
echo ""
...
echo "2 3 4" | (./micro ejemplo2.micro > /dev/null 2>&1 && gcc -o programa output.c 2>&1 > /dev/null && ./programa 2>/dev/null)
echo ""
...
echo -n "  Salida obtenida: "
./micro ejemplo3.micro > /dev/null 2>&1 && gcc -o programa output.c 2>&1 > /dev/null && ./programa 2>/dev/null
echo ""
...
echo -n "  Salida obtenida: "
./micro ejemplo4.micro > /dev/null 2>&1 && gcc -o programa output.c 2>&1 > /dev/null && ./programa 2>/dev/null
echo ""
...
echo -n "  Salida obtenida: "
./micro ejemplo5.micro > /dev/null 2>&1 && gcc -o programa output.c 2>&1 > /dev/null && ./programa 2>/dev/null
echo ""
